...
def update_iot(gate_id, water_height, gate_status):
	...
	dweepy.dweet_for('iotfloodgate_'+str(gate_id), iot_data)	
...
while True:
	try:
        ...
        # range of water height: from 0 (measured dis = maximum) to maximum  (measured dis = 0, coz water has reached its heighest, has reached sensor) 
        # add test (is water height between 0 to max?) to avoid negatives       
